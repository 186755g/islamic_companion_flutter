import '../models/prayer_dua_model.dart';

/// أذكار وأدعية الصلاة — مرجع للقراءة والحفظ فقط (لا تُعدّ بالضغط).
/// ⚠️ محتوى منقول من مرجع نصي، يُنصح بمراجعته وتوثيق كل حديث بمصدره
/// الدقيق (البخاري، مسلم، أبو داود...) قبل الاعتماد عليه في نسخة إنتاجية.
class PrayerDuasData {
  static List<PrayerDuaSection> all() => [
        ...
        const PrayerDuaSection(
          ...
          duas: [
            ...
            'اللَّهُمَّ لَكَ رَكَعْتُ، وَبِكَ آمَنْتُ، وَلَكَ اسْلَمْتُ، خَشَعَ لَكَ سَمْعِيْ، وبَصَـرِيْ، وَمُخِّيْ، وَعَظْمِيْ، وَعَصَبِيْ، وَمَا استَقَلَّتْ بِهِ قَدَمِيْ لِلهِ رَبِّ الْعَالَمِيْنَ.',
        ...
        const PrayerDuaSection(
          ...
          note:
              'بعد أن يختار أحد أدعية السجود، يُسنّ له أن يدعو بما شاء، لأن "أَقْرَبُ مَا يَكُونُ الْعَبْدُ مِنْ رَبِّهِ وَهُوَ سَاجِدٌ، فَأَكْثِرُوا الدُّعَاءَ".',
        ),
        const PrayerDuaSection(
          id: 'p5',
          ...
          note: 'كان النبي صلى الله عليه وسلم يطيل هذا الركن بقدر السجود.',
        ),
        const PrayerDuaSection(
          id: 'p6',
          title: 'دعاء سجود التلاوة',
          duas: [
            'سَجَدَ وَجْهِيَ للَّذِي خَلَقَهُ، وَشَقَّ سَمْعَهُ وبَصَرَهُ، بِحَوْلِهِ وَقُوَّتِهِ، فَتَبَارَكَ اللَّهُ أَحْسَنُ الْخَالِقِينَ.',
        ...
        const PrayerDuaSection(
          ...
          note: 'وردت صيغ أخرى للتشهد قريبة من هذا.',
        ),
        const PrayerDuaSection(
          id: 'p8',
          title: 'التشهد الأخير',
        ...
        const PrayerDuaSection(
          ...
          duas: [
            ...
            'اللَّهُمَّ اجعل جمعنا هذا جمعاً مباركاً مرحوماً، وتفرقنا من كل شر معصوماً.',
            ...
            'اللَّهُمَّ وحّد كلمة المسلمين، واجمع شملهم، واجعلهم يداً واحدة على من سواهم، وانصر اللهم المسلمين.',
            'اللَّهُمَّ إنا نسألك لولاة أمورنا الصلاح والسداد، وكن لهم عوناً، وخذ بأيديهم إلى الحق والصواب والسداد والرشاد، ووفقهم للعمل بما فيه رضاك وصالح العباد والبلاد.',
            'اللَّهُمَّ إنا نسألك لبلدنا هذا أن تجعله بلداً آمناً، وارزقه من كل الخيرات، وجنّبه الفتن ما ظهر منها وما بطن، وألّف اللهم بين قلوبنا.',
            'اللَّهُمَّ أسبغ علينا نعمتك وعلى جميع المسلمين، واملأ اللهم قلوبنا بالإيمان والقناعة، والزم جوارحنا العبادة والطاعة، واغفر اللهم لنا ولوالدينا ولإخواننا وأشياخنا ولجميع من سبقنا بالإيمان.',
          ],
          note:
              'يُختم عادة بذكر: "سُبْحَانَ رَبِّكَ رَبِّ الْعِزَّةِ عَمَّا يَصِفُونَ، وَسَلَامٌ عَلَى الْمُرْسَلِينَ، وَالْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ" (الصافات: 180-182).',
        ),
      ];
}
